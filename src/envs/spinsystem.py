...
class SpinSystemBase(ABC):
    ...
    # Note these are defined at the class level of SpinSystem to ensure that SpinSystem be pickled.
    class action_space():
    ...
    def __init__(self,
        ...
        self.n_actions = self.n_spins  # #actions = #spins
    ...
    def reset(self, spins=None):
        ...
        local_rewards_available = self.get_immeditate_rewards_avaialable(
            spinsOne)
    ...
    def step(self, action):
        ...
        if action == self.n_spins:
            ...
            if self.gg.biased:
                delta_score = self._calculate_score_change(
        ...
        for idx, observable in self.observables:
            ...
            if observable == Observable.IMMEDIATE_REWARD_AVAILABLE:
                self.state[idx, :self.n_spins] = immeditate_rewards_avaialable / \
